...
import posterImg from '../assets/images/poster-formintens.png';
import studentsImg from '../assets/images/students-studying-together-in-college-2022-08-24-23-06-32-utc.jpg';
    ...
    <React.Fragment>
      ...
      <>
        ...
        <div class="flex justify-center py-10">
          <img src="images/ss-transparent.png" alt="" class="w-2/4" />
          </div>
        ...
        <div class="flex lg:items-center -mx-4 md:justify-center flex-wrap">
          <div class="w-full px-6 mb-16 md:mb-0 md:w-1/2">
          ...
          <div class="w-full px-4 lg:w-1/2">
            <span class="inline-block py-2 px-2 mb-4 text-xl leading-5 font-medium uppercase rounded-full text-yellow-600 shadow-md">Despre noi</span>
            <p class="mb-6 lg:text-xl text-coolGray-500 font-medium text-lg">La Formintens, suntem dedicați să vă ajutăm să vă atingeți potențialul maxim prin intermediul cursurilor noastre de formare profesională.</p>
            <p class="mb-6 lg:text-xl text-coolGray-500 font-medium text-lg">Misiunea noastră este să furnizăm programe de formare relevante și actualizate, care să se alinieze nevoilor și tendințelor din piața muncii. Înțelegem importanța învățării continue și ne străduim să creăm un mediu de învățare interactiv și stimulant, în care cursanții noștri să se simtă motivați și implicați.</p>
            <p class="mb-6 lg:text-xl text-coolGray-500 font-medium text-lg">Indiferent dacă sunteți în căutarea de noi abilități, vă doriți o reconversie profesională sau vă doriți să vă perfecționați în domeniul actual, suntem aici pentru a vă ghida pe drumul succesului.</p>
            <p class="mb-6 text-lg lg:text-xl text-coolGray-500 font-medium">Pentru orice întrebări sau informații suplimentare, nu ezitați să ne contactați. Suntem aici pentru dumneavoastră!</p>
          </div>
        </div>
        </div>
      </section>
      ...
      <section 
      class="bg-white flex flex-wrap justify-center text-center py-14 md:py-18" 
      style={{ 
        backgroundImage: `url(${background})`,
        backgroundPosition: "center"}}>
        <div class="container mx-auto px-4">
        <p class="font-medium leading-relaxed mx-24 mb-10 text-xl font-bold md:text-4xl">Ce oferim?</p>
        </div>
        <div class="container px-4 mx-auto">
          <div class="flex flex-wrap -mx-4">
            <div class="w-full lg:w-1/3 px-4 mb-5">
              <div class="h-full p-8 text-center hover:bg-white hover:shadow-xl transition duration-200 border-yellow-600 border rounded-md">
                <p class="text-coolGray-500 font-medium text-lg">Suport de curs asigurat de furnizorul de formare profesionala și alte materiale precumcaiet de aplicatii practice, materiale documentare, bibliografie etc.</p>
              </div>
            </div>
            <div class="w-full lg:w-1/3 px-4 mb-5">
              <div class="h-full p-8 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200 border border-yellow-600">
                <p class="text-coolGray-500 font-medium text-lg">Sală  de curs amenajată special pentru activităţi de formare profesională, dotată cu mobilier – mese-birou, scaune, echipament de prezentare, videoproiector, ecran de proiectie</p>
              </div>
            </div>
            <div class="w-full lg:w-1/3 px-4 mb-5">
              <div class="h-full p-8 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200 border border-yellow-600">
                <p class="text-coolGray-500 font-medium text-lg">Se asigură transportul cursanților la locațiile in care au loc aplicațiile practice</p>
              </div>
            </div>
            <div class="w-full lg:w-1/3 px-4 mb-5">
              <div class="h-full p-8 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200 border border-yellow-600">
                <p class="text-coolGray-500 font-medium text-lg">Participanții au la dispoziție materiale demonstrative pentru pregătirea practică</p>
              </div>
            </div>
            <div class="w-full lg:w-1/3 px-4 mb-5">
              <div class="h-full p-8 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200 border border-yellow-600">
                <p class="text-coolGray-500 font-medium text-lg">120 ore pregătire teoretică și 240 ore pregătire practică, pe o perioadă de 12 săptămâni, fără a se depăși 30 ore pe săptamână</p>
              </div>
            </div>
            <div class="w-full lg:w-1/3 px-4 mb-5">
              <div class="h-full p-8 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200 border border-yellow-600">
                <p class="text-coolGray-500 font-medium text-lg">Formatori autorizați cu experiență în domeniu</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4 mb-14">
            <div class="flex flex-wrap">
              <div class="w-full lg:w-1/2 mb-10 lg:mb-0 px-5">
                <span class="inline-block py-2 px-2 mb-4 text-xl leading-5 font-medium uppercase rounded-9xl shadow-md text-yellow-600">PROIECTE</span>
                <h3 class="mb-4 text-3xl md:text-4xl text-coolGray-900 font-bold tracking-tighter">Educație și competențe</h3>
                <p class="text-lg md:text-xl leading-8 text-coolGray-500 font-semibold mb-6">Creșterea ocupării, precum și îmbunătățirea nivelului de competențe al tinerilor NEETs</p>
                <p class="mb-6 text-lg font-medium text-coolGray-500 leading-8">Acest proiect are două obiective specifice: creșterea ocupării tinerilor NEETs (16-29 ani) înregistrați la Serviciul Public de Ocupare din regiunile eligibile și îmbunătățirea nivelului de competențe prin evaluarea și certificarea competențelor dobândite în sistem non-formal și informal. Prin programe de formare și evaluare, proiectul sprijină dezvoltarea abilităților necesare pentru o mai mare șansă de angajare. Scopul final este integrarea cu succes a tinerilor NEETs în piața muncii și promovarea dezvoltării lor profesionale și personale, creând astfel un viitor promițător pentru ei.</p>
                <a class="flex items-center font-medium text-white hover:text-coolGray-900 text-lg bg-yellow-500 px-2 py-2 rounded-md" 
                    onClick={() => { navigate('/projectsprogress') }}>
                  <span class="mr-2">Mai multe detalii despre progresul proiectului</span>
              ...
              <div class="w-full lg:w-1/2 px-4 flex lg:justify-end justify-center items-center">
                <img class="lg:h-96 md:h-96" src={teamImg} alt="" />
      </div>
            </div>
          </div>
        </div>
      ...
      <section 
      class="bg-white xl:pt-10 py-5" 
      style={{
        backgroundImage: `url(${background})`, 
        backgroundPosition: "center"}}>
        <div class="container px-4 mx-auto flex flex-wrap justify-center">
          <div class="w-full">
            <h3 class="mb-8 text-center font-medium text-2xl leading-tight font-bold">Parteneri </h3></div>
        <div class="flex -mx-4 justify-evenly w-96">
          <a href="https://www.marinex-constructii.ro/">
            <img src="images/Marinex-Logo.png" alt="" class="rounded h-28" />
            </a>
          <a href="https://jambusiness.ro/">
            <img src="images/logo-jam.png" alt="" class="rounded shadow-md h-28" />
            </a>
            </div>
            </div>
      </section>
        ...
        <div class="flex flex-wrap -mx-4">
          ...
          <div class="w-full lg:w-1/2 px-4">
            <div class="px-4 py-8 md:p-10 bg-coolGray-50 rounded-md">
              <form action="https://formsubmit.co/formintenscentru@gmail.com" method="POST">
                <div class="mb-6">
                  <label class="block mb-2 text-coolGray-800 font-medium leading-6" for="">Nume</label>
                  <input class="block w-full py-2 px-3 appearance-none border border-coolGray-200 rounded-lg shadow-md text-coolGray-500 leading-6 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50" type="text" name="nume" placeholder="" />
                  <label class="block mb-2 text-coolGray-800 font-medium leading-6" for="">Prenume</label>
                  <input class="block w-full py-2 px-3 appearance-none border border-coolGray-200 rounded-lg shadow-md text-coolGray-500 leading-6 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50" type="text" name="prenume" placeholder="" />
                  <label class="block mb-2 text-coolGray-800 font-medium leading-6" for="">Email</label>
                  <input class="block w-full py-2 px-3 appearance-none border border-coolGray-200 rounded-lg shadow-md text-coolGray-500 leading-6 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50" type="email" name="email" placeholder="" />
      </div>
                <div class="mb-6">
                  <label class="block mb-2 text-coolGray-800 font-medium leading-6" for="">Mesajul tău</label>
                  <textarea class="block h-32 md:h-52 w-full py-2 px-3 appearance-none border border-coolGray-200 rounded-lg shadow-md text-coolGray-500 leading-6 focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 placeholder-coolGray-200 resize-none" type="text" name="mesaj" placeholder=""></textarea>
      </div>
                <button class="block w-full py-4 px-6 text-lg leading-6 font-medium text-center focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-50 rounded-md shadow-sm border border-yellow-600">Trimite</button>
              </form>
            </div>
          </div>
        </div>
