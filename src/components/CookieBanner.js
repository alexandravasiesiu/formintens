...
function CookieBanner() {
  ...
  return (
    <div class="container p-6 mx-auto flex flex-wrap border-b border-coolGray-200">
      {showBanner && (
        <>
          ...
          <div class="xl:w-1/3 w-full flex items-center font-medium xl:justify-end justify-start gap-5">
            <button
              class="text-lg bg-yellow-500 py-2 px-5 rounded-md"
              type="button"
            ...
            <button
              class="text-lg border border-yellow-500 py-2 px-5 rounded-md"
              type="button"
